...
protected:
    ...
    <body> \
        <p>The parameter must be 'ana' or 'dig' to the url /json/.</p> \
        <p>The parameter must be 'on' or 'off' to the url /D0/ to /D7/.</p> \
    </body>\n \
    </html>\n");
        return aStream;
    }
...
// "Class Web Server" implements TCPServer and provided all the methods for http server.
